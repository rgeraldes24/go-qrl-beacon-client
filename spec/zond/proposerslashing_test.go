...
func TestProposerSlashingJSON(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name:  "BadJSON",
			input: []byte(`[]`),
			err:   "invalid JSON: json: cannot unmarshal array into Go value of type zond.proposerSlashingJSON",
		},
		{
		...
		},
		{
			...
			err:   "invalid JSON: invalid JSON: json: cannot unmarshal bool into Go value of type zond.signedBeaconBlockHeaderJSON",
		},
		{
