...
func TestAttestationDataJSON(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name:  "JSONBad",
			input: []byte("[]"),
			err:   "invalid JSON: json: cannot unmarshal array into Go value of type zond.attestationDataJSON",
		},
		{
			name:  "SlotMissing",
		...
		},
		{
			...
			err:   "invalid JSON: invalid JSON: json: cannot unmarshal bool into Go value of type zond.checkpointJSON",
		},
		{
			name:  "TargetMissing",
