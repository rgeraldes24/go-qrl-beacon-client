...
//go:generate sszgen -suffix=ssz -path . -include ../spec,../spec/zond,v1,v1/zond -exclude-objs DataVersion -objs VersionedBlindedBeaconBlock,VersionedSignedBlindedBeaconBlock,VersionedSignedValidatorRegistration
