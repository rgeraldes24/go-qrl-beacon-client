...
func TestSignedVoluntaryExitJSON(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name:  "JSONBad",
			input: []byte("[]"),
			err:   "invalid JSON: json: cannot unmarshal array into Go value of type zond.signedVoluntaryExitJSON",
		},
		{
			name:  "MessageMissing",
		...
		},
		{
			...
			err:   "invalid JSON: invalid JSON: json: cannot unmarshal bool into Go value of type zond.voluntaryExitJSON",
		},
		{
			name:  "MessageInvalid",
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			var res zond.SignedVoluntaryExit
