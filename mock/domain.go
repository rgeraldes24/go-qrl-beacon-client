...
func (s *Service) Domain(ctx context.Context, domainType zond.DomainType, epoch zond.Epoch) (zond.Domain, error) {
	...
	if err != nil {
		return zond.Domain{}, errors.Wrap(err, "failed to obtain fork")
	}
...
func (s *Service) calculateDomain(ctx context.Context,
	...
	if !bytes.Equal(domainType[:], []byte{0x00, 0x00, 0x00, 0x01}) {
		...
		if err != nil {
			return zond.Domain{}, errors.Wrap(err, "failed to obtain genesis")
		}
	...
	if err != nil {
		return zond.Domain{}, errors.Wrap(err, "failed to calculate signature domain")
	}
