...
// Hash: d688e400fc786dd76706b904cbdeaa39cae2eadaad6e75d75c5e1266222fea5a
// Version: 0.1.3
package zond
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.CurrentSyncCommittee.UnmarshalSSZ(buf[2687381:3019157]); err != nil {
		return err
	}
	...
	if err = b.NextSyncCommittee.UnmarshalSSZ(buf[3019157:3350933]); err != nil {
		return err
	}

	// Offset (24) 'LatestExecutionPayloadHeader'
	if o24 = ssz.ReadOffset(buf[3350933:3350937]); o24 > size || o21 > o24 {
		return ssz.ErrOffset
	}

	// Field (25) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = WithdrawalIndex(ssz.UnmarshallUint64(buf[3350937:3350945]))

	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = ValidatorIndex(ssz.UnmarshallUint64(buf[3350945:3350953]))

	// Offset (27) 'HistoricalSummaries'
	if o27 = ssz.ReadOffset(buf[3350953:3350957]); o27 > size || o24 > o27 {
		return ssz.ErrOffset
	}
