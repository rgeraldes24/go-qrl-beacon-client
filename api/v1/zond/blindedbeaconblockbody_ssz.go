...
// Hash: 77f44793d6be6d97183d8cb1e2524b29c6e06e0c2ffb4b8466d7274071f11ee1
// Version: 0.1.3
package zond
...
func (b *BlindedBeaconBlockBody) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if b.ExecutionData == nil {
		b.ExecutionData = new(zond.ExecutionData)
	}
	...
	if b.SyncAggregate == nil {
		b.SyncAggregate = new(zond.SyncAggregate)
	}
...
func (b *BlindedBeaconBlockBody) UnmarshalSSZ(buf []byte) error {
	...
	// Field (3) 'ProposerSlashings'
	{
		...
		b.ProposerSlashings = make([]*zond.ProposerSlashing, num)
		for ii := 0; ii < num; ii++ {
			if b.ProposerSlashings[ii] == nil {
				b.ProposerSlashings[ii] = new(zond.ProposerSlashing)
			}
	...
	// Field (4) 'AttesterSlashings'
	{
		...
		b.AttesterSlashings = make([]*zond.AttesterSlashing, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if b.AttesterSlashings[indx] == nil {
				b.AttesterSlashings[indx] = new(zond.AttesterSlashing)
			}
	...
	// Field (5) 'Attestations'
	{
		...
		b.Attestations = make([]*zond.Attestation, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if b.Attestations[indx] == nil {
				b.Attestations[indx] = new(zond.Attestation)
			}
	...
	// Field (6) 'Deposits'
	{
		...
		b.Deposits = make([]*zond.Deposit, num)
		for ii := 0; ii < num; ii++ {
			if b.Deposits[ii] == nil {
				b.Deposits[ii] = new(zond.Deposit)
			}
	...
	// Field (7) 'VoluntaryExits'
	{
		...
		b.VoluntaryExits = make([]*zond.SignedVoluntaryExit, num)
		for ii := 0; ii < num; ii++ {
			if b.VoluntaryExits[ii] == nil {
				b.VoluntaryExits[ii] = new(zond.SignedVoluntaryExit)
			}
	...
	// Field (9) 'ExecutionPayloadHeader'
	{
		...
		if b.ExecutionPayloadHeader == nil {
			b.ExecutionPayloadHeader = new(zond.ExecutionPayloadHeader)
		}
